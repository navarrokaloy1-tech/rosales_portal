...
export const USERS: User[] = [
  ...
  { id: 'u-s1',  lrn: '136501230001', firstName: 'Juan',     lastName: 'Cruz',     email: 'juan.cruz@student.rnhs.edu.ph',     role: 'Student', avatarColor: '#B71C1C' },
  { id: 'u-s2',  lrn: '136501230002', firstName: 'Maria',    lastName: 'Dela Cruz',email: 'maria.delacruz@student.rnhs.edu.ph', role: 'Student', avatarColor: '#1E3A8A' },
  { id: 'u-s3',  lrn: '136501230003', firstName: 'Pedro',    lastName: 'Garcia',   email: 'pedro.garcia@student.rnhs.edu.ph',  role: 'Student', avatarColor: '#2E7D32' },
  { id: 'u-s4',  lrn: '136501230004', firstName: 'Ana',      lastName: 'Mendoza',  email: 'ana.mendoza@student.rnhs.edu.ph',   role: 'Student', avatarColor: '#F5B400' },
  { id: 'u-s5',  lrn: '136501230005', firstName: 'Carlos',   lastName: 'Lopez',    email: 'carlos.lopez@student.rnhs.edu.ph',  role: 'Student', avatarColor: '#7B1FA2' },
  { id: 'u-s6',  lrn: '136501230006', firstName: 'Sofia',    lastName: 'Hernandez',email: 'sofia.h@student.rnhs.edu.ph',       role: 'Student', avatarColor: '#0277BD' },
  { id: 'u-s7',  lrn: '136501230007', firstName: 'Miguel',   lastName: 'Torres',   email: 'miguel.t@student.rnhs.edu.ph',      role: 'Student', avatarColor: '#C62828' },
  { id: 'u-s8',  lrn: '136501230008', firstName: 'Isabella', lastName: 'Ramos',    email: 'isabella.r@student.rnhs.edu.ph',    role: 'Student', avatarColor: '#388E3C' },
  { id: 'u-s9',  lrn: '136501230009', firstName: 'Diego',    lastName: 'Flores',   email: 'diego.f@student.rnhs.edu.ph',       role: 'Student', avatarColor: '#5D4037' },
  { id: 'u-s10', lrn: '136501230010', firstName: 'Camila',   lastName: 'Rivera',   email: 'camila.r@student.rnhs.edu.ph',      role: 'Student', avatarColor: '#00838F' },

  // Students (Grade 10 - Bonifacio)
  { id: 'u-s11', lrn: '136501230011', firstName: 'Rafael',   lastName: 'Santos',    email: 'rafael.s@student.rnhs.edu.ph',     role: 'Student', avatarColor: '#E65100' },
  { id: 'u-s12', lrn: '136501230012', firstName: 'Gabriela', lastName: 'Villanueva',email: 'gabriela.v@student.rnhs.edu.ph',   role: 'Student', avatarColor: '#AD1457' },
  { id: 'u-s13', lrn: '136501230013', firstName: 'Andres',   lastName: 'Bautista',  email: 'andres.b@student.rnhs.edu.ph',     role: 'Student', avatarColor: '#1565C0' },
  { id: 'u-s14', lrn: '136501230014', firstName: 'Elena',    lastName: 'Aquino',    email: 'elena.a@student.rnhs.edu.ph',      role: 'Student', avatarColor: '#2E7D32' },
  { id: 'u-s15', lrn: '136501230015', firstName: 'Marco',    lastName: 'Pascual',   email: 'marco.p@student.rnhs.edu.ph',      role: 'Student', avatarColor: '#6A1B9A' },
  { id: 'u-s16', lrn: '136501230016', firstName: 'Patricia', lastName: 'Soriano',   email: 'patricia.s@student.rnhs.edu.ph',   role: 'Student', avatarColor: '#00695C' },
  { id: 'u-s17', lrn: '136501230017', firstName: 'Luis',     lastName: 'Castillo',  email: 'luis.c@student.rnhs.edu.ph',       role: 'Student', avatarColor: '#BF360C' },
  { id: 'u-s18', lrn: '136501230018', firstName: 'Teresa',   lastName: 'Navarro',   email: 'teresa.n@student.rnhs.edu.ph',     role: 'Student', avatarColor: '#283593' },

  // Students (Grade 9 - Mabini)
  { id: 'u-s19', lrn: '136501230019', firstName: 'Joaquin',  lastName: 'Manalo',    email: 'joaquin.m@student.rnhs.edu.ph',    role: 'Student', avatarColor: '#4E342E' },
  { id: 'u-s20', lrn: '136501230020', firstName: 'Bianca',   lastName: 'Salazar',   email: 'bianca.s@student.rnhs.edu.ph',     role: 'Student', avatarColor: '#00838F' },
  { id: 'u-s21', lrn: '136501230021', firstName: 'Daniel',   lastName: 'Reyes',     email: 'daniel.r@student.rnhs.edu.ph',     role: 'Student', avatarColor: '#558B2F' },
  { id: 'u-s22', lrn: '136501230022', firstName: 'Angela',   lastName: 'Cruz',      email: 'angela.c@student.rnhs.edu.ph',     role: 'Student', avatarColor: '#D84315' },
  { id: 'u-s23', lrn: '136501230023', firstName: 'Ricardo',  lastName: 'Tan',       email: 'ricardo.t@student.rnhs.edu.ph',    role: 'Student', avatarColor: '#1A237E' },
  { id: 'u-s24', lrn: '136501230024', firstName: 'Jasmine',  lastName: 'Dizon',     email: 'jasmine.d@student.rnhs.edu.ph',    role: 'Student', avatarColor: '#880E4F' },
  { id: 'u-s25', lrn: '136501230025', firstName: 'Gabriel',  lastName: 'Lim',       email: 'gabriel.l@student.rnhs.edu.ph',    role: 'Student', avatarColor: '#33691E' },
  { id: 'u-s26', lrn: '136501230026', firstName: 'Nicole',   lastName: 'Abad',      email: 'nicole.a@student.rnhs.edu.ph',     role: 'Student', avatarColor: '#0D47A1' },

  // Students (Grade 9 - Aguinaldo)
  { id: 'u-s27', lrn: '136501230027', firstName: 'Antonio',  lastName: 'Mercado',   email: 'antonio.m@student.rnhs.edu.ph',    role: 'Student', avatarColor: '#E65100' },
  { id: 'u-s28', lrn: '136501230028', firstName: 'Clara',    lastName: 'Santiago',  email: 'clara.s@student.rnhs.edu.ph',      role: 'Student', avatarColor: '#4A148C' },
  { id: 'u-s29', lrn: '136501230029', firstName: 'Manuel',   lastName: 'Ocampo',    email: 'manuel.o@student.rnhs.edu.ph',     role: 'Student', avatarColor: '#1B5E20' },
  { id: 'u-s30', lrn: '136501230030', firstName: 'Rosa',     lastName: 'Enriquez',  email: 'rosa.e@student.rnhs.edu.ph',       role: 'Student', avatarColor: '#B71C1C' },
  { id: 'u-s31', lrn: '136501230031', firstName: 'Fernando', lastName: 'Luna',      email: 'fernando.l@student.rnhs.edu.ph',   role: 'Student', avatarColor: '#263238' },
  { id: 'u-s32', lrn: '136501230032', firstName: 'Victoria', lastName: 'Gomez',     email: 'victoria.g@student.rnhs.edu.ph',   role: 'Student', avatarColor: '#F57F17' },

  // Students (Grade 8 - Jacinto)
  { id: 'u-s33', lrn: '136501230033', firstName: 'Emilio',   lastName: 'Aguilar',   email: 'emilio.a@student.rnhs.edu.ph',     role: 'Student', avatarColor: '#311B92' },
  { id: 'u-s34', lrn: '136501230034', firstName: 'Lucia',    lastName: 'Dominguez', email: 'lucia.d@student.rnhs.edu.ph',      role: 'Student', avatarColor: '#01579B' },
  { id: 'u-s35', lrn: '136501230035', firstName: 'Alejandro',lastName: 'Ferrer',    email: 'alejandro.f@student.rnhs.edu.ph',  role: 'Student', avatarColor: '#827717' },
  { id: 'u-s36', lrn: '136501230036', firstName: 'Carmen',   lastName: 'Vega',      email: 'carmen.v@student.rnhs.edu.ph',     role: 'Student', avatarColor: '#B71C1C' },
  { id: 'u-s37', lrn: '136501230037', firstName: 'Santiago',  lastName: 'Ruiz',     email: 'santiago.r@student.rnhs.edu.ph',   role: 'Student', avatarColor: '#004D40' },
  { id: 'u-s38', lrn: '136501230038', firstName: 'Valentina',lastName: 'Morales',   email: 'valentina.m@student.rnhs.edu.ph',  role: 'Student', avatarColor: '#E91E63' },
  { id: 'u-s39', lrn: '136501230039', firstName: 'Roberto',  lastName: 'Ibarra',    email: 'roberto.i@student.rnhs.edu.ph',    role: 'Student', avatarColor: '#1A237E' },
  { id: 'u-s40', lrn: '136501230040', firstName: 'Marisol',  lastName: 'Padilla',   email: 'marisol.p@student.rnhs.edu.ph',    role: 'Student', avatarColor: '#3E2723' },
];
